package conference.hotel.temp;

import javax.validation.constraints.NotNull;
import javax.validation.constraints.Size;

import Conference.hotel.validation.FieldMatch;
import Conference.hotel.validation.ValidEmail;
...
public class CurrentUser {
	...
	// temp class to filter data and get it from controller to database using
	// services
